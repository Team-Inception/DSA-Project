...
public class Real_Estate extends javax.swing.JFrame {
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        if (lotText.getText().isEmpty()) {
            statusLabel.setText("Please Enter The Lot Number");
        } else if (firstText.getText().isEmpty()) {
            statusLabel.setText("Please Enter First Name ");
        } else if (lastText.getText().isEmpty()) {
            statusLabel.setText("Please Enter Last Name");
        } else if (priceText.getText().isEmpty()) {
            statusLabel.setText("Please Enter The Price");
        } else if (feetText.getText().isEmpty()) {
            statusLabel.setText("Please Enter Squrefeet Amount");
        } else if (noOfBedText.getText().isEmpty()) {
            statusLabel.setText("Please Enter The No Of Bedrooms");
        } else {
            try {
                house = dataRetriver();
                if (list.availability(house)) {
                ...
                statusLabel.setText("Invalid Type Entry!");
            }
        }
    ...
    private void LotNumTextKeyTyped(java.awt.event.KeyEvent evt) {
        ...
        if (!((c >= '0') && (c <= '9') || (c == KeyEvent.VK_BACK_SPACE) || (c == KeyEvent.VK_DELETE))) {
            ...
            statusLabel.setText("You Can Only Type Numbers In This Field");
        } else {
...
//			        catch (Exception ex)
//			        {
//			          System.out.println("Issue in "+ex); 
//			                            
//			        }
//			        System.exit(0); 
//            }
